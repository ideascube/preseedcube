...
wget -O /tmp/read_from_amqp.sh http://gogs/outils-interne/temps_modernes_v1/raw/master/read_from_amqp_ideasbox.sh
...
/tmp/buildMyCube.sh -n "$deviceName" -t "$timeZone"
